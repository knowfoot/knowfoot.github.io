function propo() {
  ...
  var getW = document.body.clientWidth, getH = window.innerHeight;
  var getScaleW = getW / 756, getScaleH = getH / 960;
...
function getAction(_getLi, _UD) {
  ...
  if (_UD) {
    ...
    let getAudio = $(_getLi).find("audio")[0];
    if (getAudio.currentTime) {
      getAudio.currentTime = 0
    }
    getAudio.play()
  } else {
    $(_getLi).removeClass("down")
  }
}
